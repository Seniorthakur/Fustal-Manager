...
## Latest Railway Build Fix

This package includes a local TypeScript declaration for `bcryptjs` at `types/bcryptjs.d.ts`. This avoids Railway/Next.js production builds failing with `Could not find a declaration file for module bcryptjs`.
